...
class ToDoAdapter(
    ...
    override fun onBindViewHolder(holder: ToDoViewHolder, position: Int) {
        ...
        // set color and label for priority
        when (item.priority) {
            Priority.HIGH -> {
                holder.binding.textPriority.text = "High Priority"
                holder.binding.textPriority.setTextColor(Color.parseColor("#B71C1C"))
            ...
            Priority.MEDIUM -> {
                ...
                holder.binding.textPriority.setTextColor(Color.parseColor("#FF8800"))
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            ...
            Priority.LOW -> {
                ...
                holder.binding.textPriority.setTextColor(Color.parseColor("#388E3C"))
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
